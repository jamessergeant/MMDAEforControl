...
def train():
    ...
    hyper_params = {"mode1_dataset" : os.environ['MMDAEdata'] + 'short_laser.npy',
        ...
        "h11_dim" : round(sequence*mode1_dim*overcomplete_multiplier),
        "h12_dim" : round(sequence*mode2_multiplier*mode2_dim*overcomplete_multiplier),
        "h2_dim" : round((round(sequence*mode1_dim*overcomplete_multiplier) + round(sequence*mode2_multiplier*mode2_dim*overcomplete_multiplier)) * overcomplete_multiplier),
        "h3_dim": round(sequence*mode1_dim*overcomplete_multiplier) + round(sequence*mode2_multiplier*mode2_dim*overcomplete_multiplier),
        "type" : 'laser_command_smae',
